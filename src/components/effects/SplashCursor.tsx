...
// Midnight Rose defaults:
// - RAINBOW_MODE is off by default so the cursor stays on-brand (rose/magenta)
//   rather than cycling through arbitrary hues.
// - COLOR defaults to the rose-primary token (#d6407e).
// - BACK_COLOR uses a deep rose-black tint instead of pure red, so any base
//   tint that leaks through reads as "moody dark rose" rather than "blood red".
export default function SplashCursor({
  ...
  BACK_COLOR = { r: 0.04, g: 0.02, b: 0.035 },
  TRANSPARENT = true,
  RAINBOW_MODE = false,
  COLOR = '#d6407e'
}: SplashCursorProps) {
